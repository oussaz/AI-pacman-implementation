...
<p> 
  <div id="banner">
      ...
      <img src="/img/tracking/1.png" width = "350" title="First iterations : The lighter the color, the higher the probability">
      <img src="/img/tracking/2.png" width = "350" title="After few iterations : The lighter the color, the higher the probability">
     </div>
  </div>
</p>
