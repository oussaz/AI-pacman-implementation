...
![Alt text](/img/tracking/1.png?raw=true "First iterations : The lighter the color, the higher the probability")
![Alt text](/img/tracking/2.png?raw=true "After few iterations : The lighter the color, the higher the probability")
